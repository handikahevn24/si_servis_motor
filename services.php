...
class Service{
	...
	public function connect_db(){
		$this->connection = mysqli_connect('localhost', 'root', '', 'si_servis_motor');
	...
	public function create($fname,$lname,$email,$gender,$age){
		$sql = "INSERT INTO `services` (firstname, lastname, email, gender, age) VALUES ('$fname', '$lname', '$email', '$gender', '$age')";
